...
if (fields == 1 .OR. fields == 3) then
  ...
  wB1 = interB2particle(Hx1,Hy1,Hz1,Hii,Hip,Hri,pwall,sB,geo,px1(3),fields)
  wB2 = interB2particle(Hx2,Hy2,Hz2,Hii,Hip,Hri,pwall,sB,geo,px1(3),fields)
...
if (s > 0) then
  ...
  do k = 1,s
    ...
    if ((px2t(k,1)>0. .AND. px2t(k,1)<a) .AND. (px2t(k,2)>0. .AND. px2t(k,2)<b) &
      ...
      if (fields == 1 .OR. fields == 3) then
        ! Interpolate fields from grid to collision point
	wB0 = interB2particle(Hx0,Hy0,Hz0,Hii,Hip,Hri,pwall,sB,geo,px1(3),fields)
	...
	! Interpolate fields from nodes to particles
	eB1 = interB2particle(Hx1,Hy1,Hz1,Hii,Hip,Hri,pwall,sB,geo,px1(3),fields)
	eB2 = interB2particle(Hx2,Hy2,Hz2,Hii,Hip,Hri,pwall,sB,geo,px1(3),fields)
